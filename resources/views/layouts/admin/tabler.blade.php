...
<html lang="en">
  ...
  <body >
    <script src="{{ asset('tabler/dist/js/demo-theme.min.js?1667333929') }}"></script>
    <div class="page">
      <!-- Header -->
    ...
    <!-- Libs JS -->
    <script src="{{ asset('tabler/dist/libs/apexcharts/dist/apexcharts.min.js?1667333929') }}" defer></script>
    <script src="{{ asset('tabler/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1667333929') }}" defer></script>
    <script src="{{ asset('tabler/dist/libs/jsvectormap/dist/maps/world.js?1667333929') }}" defer></script>
    <script src="{{ asset('tabler/dist/libs/jsvectormap/dist/maps/world-merc.js?1667333929') }}" defer></script>
    <!-- Tabler Core -->
