                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" name="nama_dept" id="nama_dept" class="form-control" placeholder="Cari Departemen" value="{{ Request('nama_dept') }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                      ...
                                                      <form action="/departemen/{{$d->kode_dept}}/delete" method="POST" style="margin-left:2px">
                                                      @csrf
