                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td>
                                                    @if (empty($d->foto))
                                                    <img src="{{ asset('storage/public/upload/karyawan/noimage.png') }}" class="avatar" alt=""> 
                                                    @else
                ...
                <div class="col-12">
                    <div class="input-icon mb-3">
                      ...
                      <div class="input-icon mb-3">
                        ...
                        <input type="text" value="" id="jobdesk" class="form-control" name="jobdesk" placeholder="Jobdesk" required >
                      </div>
                      <div class="input-icon mb-3">
                        <span class="input-icon-addon">
                          <!-- Download SVG icon from http://tabler-icons.io/i/user -->
